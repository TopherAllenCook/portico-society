...
const SECURITY_HEADERS = [
  ...
  // Tighten once a CSP-report endpoint is wired.
  {
    ...
    value: [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://app.cal.com https://cal.com https://*.vercel-scripts.com https://www.googletagmanager.com https://elevenlabs.io",
      "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
      "font-src 'self' data: https://fonts.gstatic.com",
      "img-src 'self' data: blob: https:",
      "media-src 'self' data: blob: https:",
      "connect-src 'self' https://app.cal.com https://cal.com https://api.cal.com https://*.supabase.co https://vitals.vercel-insights.com https://www.google-analytics.com https://*.analytics.google.com https://www.googletagmanager.com https://elevenlabs.io https://*.elevenlabs.io",
      "frame-src 'self' https://app.cal.com https://cal.com https://elevenlabs.io",
      "object-src 'none'",
      "base-uri 'self'",
      "form-action 'self'",
