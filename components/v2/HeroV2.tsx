...
export default function HeroV2() {
  ...
  function rise(delay: number, distance = '2rem'): React.CSSProperties {
    ...
    return {
      opacity: entered ? 1 : 0,
      transform: entered ? 'translateY(0)' : `translateY(${distance})`,
    ...
    >
      ...
      <div className="relative z-10 flex flex-1 flex-col justify-center px-6 pb-28 pt-40 lg:px-16 lg:pb-32 lg:pt-44">
        <div className="mx-auto w-full max-w-5xl">
          ...
          {/* Headline — three stacked lines, last line in cinnabar italic */}
          <h1
          ...
          <div className="mt-12 flex flex-wrap items-center gap-5 lg:mt-14" style={rise(620)}>
            ...
            <Link
              href="#services"
              className="font-mono text-xs font-medium uppercase tracking-[0.13em] transition-opacity duration-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4"
              style={{ color: 'oklch(97% 0.008 75 / 0.4)', outlineColor: 'oklch(97% 0.008 75 / 0.4)' }}
              onMouseEnter={e => { e.currentTarget.style.color = 'oklch(97% 0.008 75 / 0.8)' }}
              onMouseLeave={e => { e.currentTarget.style.color = 'oklch(97% 0.008 75 / 0.4)' }}
            >
              See Specialties
            </Link>
          </div>
          ...
          <p
            ...
            style={{ color: 'oklch(97% 0.008 75 / 0.22)', ...rise(720) }}
          >
      ...
      >
        <svg
          ...
          style={{ color: 'oklch(97% 0.008 75 / 0.2)' }}
        >
